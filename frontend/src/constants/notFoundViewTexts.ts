export const NOTFOUND_INITIAL_CLOCK = '--:--:--'

export const NOTFOUND_HEADER_TEXTS = {
    timeLabel: 'ВРЕМЯ ОБХОДА',
    departmentLabel: 'ОТДЕЛЕНИЕ',
    departmentValue: 'SYS · INFRA',
} as const

export const NOTFOUND_HERO_TEXTS = {
    eyebrow: 'Диагностический отчёт',
    digitFour: '4',
    digitZero: '0',
...
export const NOTFOUND_MONITOR_TEXTS = {
    eyebrow: 'Кардиомонитор маршрута',
    hrLabel: 'HR',
    hrValue: '— —',
    hrUnit: 'bpm',
    spo2Value: '—',
